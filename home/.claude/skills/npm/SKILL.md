...
- **Use the install script instead of `npm install`**: When installing packages, use `node ~/.claude/skills/npm/scripts/install.js [--dev] <package1> [package2] ...` instead of `npm install`. This script automatically:
...
This file is in `~/.claude/skills/npm/` - take all paths as relative to it. Script: [scripts/install.js](./scripts/install.js)
